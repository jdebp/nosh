...
echo convert/at-spi-dbus-bus.service convert/dbus.service convert/dconf-service.service convert/dhclient@.service convert/gconfd.service convert/gnome-terminal-server.service convert/gvfs-daemon.service convert/gvfs-udisks2-volume-monitor.service convert/gvfs-afc-volume-monitor.service convert/gvfs-goa-volume-monitor.service convert/gvfs-hal-volume-monitor.service convert/gvfs-gphoto2-volume-monitor.service convert/gvfs-mtp-volume-monitor.service convert/gvfs-metadata.service convert/mate-notification-daemon.service convert/mpd.service convert/per-user.conf convert/run-user-directory@.service convert/user-dbus.service convert/zeitgeist-fts.service
