...
#define FUNKABLE1(m,n,q,r,e) { 'f', { EXTE(e),FUNK(n),FUNK(q),FUNK(r),SCRN((m)-1U),SCRN((n)-1U),SCRN((q)-1U),SCRN((r)-1U),EXTE(e),FUNK(n),FUNK(q),FUNK(r),SCRN((m)-1U),SCRN((n)-1U),SCRN((q)-1U),SCRN((r)-1U) } }
#define FUNKABLE2(m,n,q,r) { 'f', { FUNK(m),FUNK(n),FUNK(q),FUNK(r),SCRN((m)-1U),SCRN((n)-1U),SCRN((q)-1U),SCRN((r)-1U),FUNK(m),FUNK(n),FUNK(q),FUNK(r),SCRN((m)-1U),SCRN((n)-1U),SCRN((q)-1U),SCRN((r)-1U) } }
...
static 
const kbdmap_entry
English_international_keyboard[17][16] =
{
	// 00: ISO 9995 "E" row
	{
		SIMPLE(NOOP(0xFEFF)),
/*01*/		SIMPLE(UCSA(0x1b)),
/*02*/		SHIFTABLE(UCSA('1'),UCSA('!'),UCSA(L'¡'),UCSA(L'¹'),UCSA(0x00B9),UCSA(0x00A1),UCSA(0x02B9),NOOP(9995)),
/*03*/		SHIFTABLE_CONTROL(UCSA('2'),UCSA('@'),UCSA(L'²'),UCSA(L'⅔'),UCSA(0x00),UCSA(0x00B2),UCSA(0x00A4),UCSA(0x02BA),NOOP(9995)),
/*04*/		SHIFTABLE(UCSA('3'),UCSA('#'),UCSA(L'³'),UCSA(L'⅜'),UCSA(0x00B3),UCSA(0x00A3),UCSA(0x02BF),NOOP(9995)),
/*05*/		SHIFTABLE(UCSA('4'),UCSA('$'),UCSA(L'¤'),UCSA(L'£'),UCSA(0x00BC),UCSA(0x20AC),UCSA(0x02BE),NOOP(9995)),
/*06*/		SHIFTABLE(UCSA('5'),UCSA('%'),UCSA(L'€'),UCSA(L'‰'),UCSA(0x00BD),UCSA(0x2191),UCSA(0x02C1),NOOP(9995)),
/*07*/		SHIFTABLE_CONTROL(UCSA('6'),UCSA('^'),UCSA(L'¼'),UCSA(L'⅙'),UCSA(0x1E),UCSA(0x00BE),UCSA(0x2193),UCSA(0x02C0),NOOP(9995)),
/*08*/		SHIFTABLE(UCSA('7'),UCSA('&'),UCSA(L'½'),UCSA(L'⅞'),UCSA(0x215B),UCSA(0x2190),UCSA(0x007B),NOOP(9995)),
/*09*/		SHIFTABLE(UCSA('8'),UCSA('*'),UCSA(L'¾'),UCSA(L'⅛'),UCSA(0x215C),UCSA(0x2192),UCSA(0x007D),NOOP(9995)),
/*0A*/		SHIFTABLE(UCSA('9'),UCSA('('),UCSA(L'‘'),UCSA(L'⅟'),UCSA(0x215D),UCSA(0x00B1),UCSA(0x005B),NOOP(9995)),
/*0B*/		SHIFTABLE(UCSA('0'),UCSA(')'),UCSA(L'’'),UCSA(L'⁄'),UCSA(0x215E),UCSA(0x2122),UCSA(0x005D),NOOP(9995)),
/*0C*/		SHIFTABLE_CONTROL(UCSA('-'),UCSA('_'),UCSA(0x2013),UCSA(0x2014),UCSA(0x1F),UCSA(0x005C),UCSA(0x00BF),UCSA(0x02BB),NOOP(9995)),
/*0D*/		SHIFTABLE(UCSA('='),UCSA('+'),UCSA(L'×'),UCSA(L'÷'),UCSA(0x0327),UCSA(0x0328),UCSA(0x00AC),NOOP(9995)),
/*0E*/		SIMPLE(EXTE(EXTENDED_KEY_BACKSPACE)),
		SIMPLE(NOOP(0)),
	},
	// 01: ISO 9995 "D" row
	{
/*0F*/		SHIFTABLE(UCSA(0x09),EXTE(EXTENDED_KEY_BACKTAB),UCSA(0x09),EXTE(EXTENDED_KEY_BACKTAB),UCSA(0x09),EXTE(EXTENDED_KEY_BACKTAB),UCSA(0x09),EXTE(EXTENDED_KEY_BACKTAB)),
/*10*/		CAPSABLE_CONTROL(UCSA('q'),UCSA('Q'),UCSA(L'ä'),UCSA(L'Ä'),UCSA('q'-0x60),UCSA(0x0242),UCSA(0x0241),UCSA(0x030D),NOOP(9995)),
/*11*/		CAPSABLE_CONTROL(UCSA('w'),UCSA('W'),UCSA(L'å'),UCSA(L'Å'),UCSA('w'-0x60),UCSA(0x02B7),UCSA(0x2126),UCSA(0x0307),NOOP(9995)),
/*12*/		CAPSABLE_CONTROL(UCSA('e'),UCSA('E'),UCSA(L'é'),UCSA(L'É'),UCSA('e'-0x60),UCSA(0x0153),UCSA(0x0152),UCSA(0x0306),NOOP(9995)),
/*13*/		CAPSABLE_CONTROL(UCSA('r'),UCSA('R'),UCSA(L'™'),UCSA(L'®'),UCSA('r'-0x60),UCSA(0x00B6),UCSA(0x00AE),UCSA(0x0302),NOOP(9995)),
/*14*/		CAPSABLE_CONTROL(UCSA('t'),UCSA('T'),UCSA(L'þ'),UCSA(L'Þ'),UCSA('t'-0x60),UCSA(0xA78C),UCSA(0xA78B),UCSA(0x0308),NOOP(9995)),
/*15*/		CAPSABLE_CONTROL(UCSA('y'),UCSA('Y'),UCSA(L'ü'),UCSA(L'Ü'),UCSA('y'-0x60),UCSA(0x027C),UCSA(0x00A5),UCSA(0x0311),NOOP(9995)),
/*16*/		CAPSABLE_CONTROL(UCSA('u'),UCSA('U'),UCSA(L'ú'),UCSA(L'Ú'),UCSA('u'-0x60),UCSA(0x0223),UCSA(0x0222),UCSA(0x030C),NOOP(9995)),
/*17*/		CAPSABLE_CONTROL(UCSA('i'),UCSA('I'),UCSA(L'í'),UCSA(L'Í'),UCSA('i'-0x60),UCSA(0x0131),UCSA(0x214D),UCSA(0x0313),NOOP(9995)),
/*18*/		CAPSABLE_CONTROL(UCSA('o'),UCSA('O'),UCSA(L'ó'),UCSA(L'Ó'),UCSA('o'-0x60),UCSA(0x00F8),UCSA(0x00D8),UCSA(0x031B),NOOP(9995)),
/*19*/		CAPSABLE_CONTROL(UCSA('p'),UCSA('P'),UCSA(L'ö'),UCSA(L'Ö'),UCSA('p'-0x60),UCSA(0x00FE),UCSA(0x00DE),UCSA(0x0309),NOOP(9995)),
/*1A*/		SHIFTABLE_CONTROL(UCSA('['),UCSA('{'),UCSA(L'«'),UCSA(L'“'),UCSA(0x1B),UCSA(0x017F),UCSA(0x030A),UCSA(0x0300),NOOP(9995)),
/*1B*/		SHIFTABLE_CONTROL(UCSA(']'),UCSA('}'),UCSA(L'»'),UCSA(L'”'),UCSA(0x1D),UCSA(0x0303),UCSA(0x0304),UCSA(0x0040),NOOP(9995)),
/*1C*/		SIMPLE(EXTE(EXTENDED_KEY_RETURN_OR_ENTER)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
	},
	// 02: ISO 9995 "C" row
	{
		SIMPLE(NOOP(0)),
/*1E*/		CAPSABLE_CONTROL(UCSA('a'),UCSA('A'),UCSA(L'á'),UCSA(L'Á'),UCSA('a'-0x60),UCSA(0x00E6),UCSA(0x00C6),UCSA(0x0329),NOOP(9995)),
/*1F*/		CAPSABLE_CONTROL(UCSA('s'),UCSA('S'),UCSA(L'ß'),UCSA(L'§'),UCSA('s'-0x60),UCSA(0x00DF),UCSA(0x00A7),UCSA(0x0323),NOOP(9995)),
/*20*/		CAPSABLE_CONTROL(UCSA('d'),UCSA('D'),UCSA(L'ð'),UCSA(L'Ð'),UCSA('d'-0x60),UCSA(0x00F0),UCSA(0x00D0),UCSA(0x032E),NOOP(9995)),
/*21*/		CAPSABLE_CONTROL(UCSA('f'),UCSA('F'),NOOP(0),NOOP(0),UCSA('f'-0x60),UCSA(0x0294),UCSA(0x00AA),UCSA(0x032D),NOOP(9995)),
/*22*/		CAPSABLE_CONTROL(UCSA('g'),UCSA('G'),NOOP(0),NOOP(0),UCSA('g'-0x60),UCSA(0x014B),UCSA(0x014A),UCSA(0x0331),NOOP(9995)),
/*23*/		CAPSABLE_CONTROL(UCSA('h'),UCSA('H'),UCSA(0x2020),UCSA(0x2021),UCSA('h'-0x60),UCSA(0x0272),UCSA(0x019D),UCSA(0x0332),NOOP(9995)),
/*24*/		CAPSABLE_CONTROL(UCSA('j'),UCSA('J'),NOOP(0),NOOP(0),UCSA('j'-0x60),UCSA(0x0133),UCSA(0x0132),UCSA(0x0325),NOOP(9995)),
/*25*/		CAPSABLE_CONTROL(UCSA('k'),UCSA('K'),UCSA(L'œ'),UCSA(L'Œ'),UCSA('k'-0x60),UCSA(0x0138),UCSA(0x0325),UCSA(0x0335),NOOP(9995)),
/*26*/		CAPSABLE_CONTROL(UCSA('l'),UCSA('L'),UCSA(L'ø'),UCSA(L'Ø'),UCSA('l'-0x60),UCSA(0x0142),UCSA(0x0141),UCSA(0x0338),NOOP(9995)),
/*27*/		SHIFTABLE(UCSA(';'),UCSA(':'),UCSA(L'¶'),UCSA(L'°'),UCSA(0x0301),UCSA(0x030B),UCSA(0x00B0),NOOP(9995)),
/*28*/		SHIFTABLE(UCSA('\''),UCSA('\"'),UCSA(L'´'),UCSA(L'¨'),UCSA(0x019B),UCSA(0x1E9E),UCSA(0x2032),NOOP(9995)),
/*29*/		SHIFTABLE(UCSA('`'),UCSA('~'),UCSA(L'±'),UCSA(L'¥'),UCSA(0x204A),UCSA(0x00AD),UCSA(0x007C),NOOP(9995)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
		SIMPLE(UCSA(0x0A)),
	},
	...
	{
		SIMPLE(NOOP(0)),
/*2B*/		SHIFTABLE_CONTROL(UCSA('\\'),UCSA('|'),UCSA(L'¬'),UCSA(L'¦'),UCSA(0x1C),UCSA(0x0259),UCSA(0x018F),UCSA(0x2033),NOOP(9995)),
/*2C*/		CAPSABLE_CONTROL(UCSA('z'),UCSA('Z'),UCSA(L'æ'),UCSA(L'Æ'),UCSA('z'-0x60),UCSA(0x0292),UCSA(0x01B7),UCSA(0x00AB),NOOP(9995)),
/*2D*/		CAPSABLE_CONTROL(UCSA('x'),UCSA('X'),NOOP(0),NOOP(0),UCSA('x'-0x60),UCSA(0x201E),UCSA(0x201A),UCSA(0x00BB),NOOP(9995)),
/*2E*/		CAPSABLE_CONTROL(UCSA('c'),UCSA('C'),UCSA(L'¢'),UCSA(L'©'),UCSA('c'-0x60),UCSA(0x00A2),UCSA(0x00A9),UCSA(0x2015),NOOP(9995)),
/*2F*/		CAPSABLE_CONTROL(UCSA('v'),UCSA('V'),UCSA(L'ł'),UCSA(L'Ł'),UCSA('v'-0x60),UCSA(0x201C),UCSA(0x2018),UCSA(0x2039),NOOP(9995)),
/*30*/		CAPSABLE_CONTROL(UCSA('b'),UCSA('B'),NOOP(0),NOOP(0),UCSA('b'-0x60),UCSA(0x201D),UCSA(0x2019),UCSA(0x203A),NOOP(9995)),
/*31*/		CAPSABLE_CONTROL(UCSA('n'),UCSA('N'),UCSA(L'ñ'),UCSA(L'Ñ'),UCSA('n'-0x60),UCSA(0x019E),UCSA(0x0220),UCSA(0x2013),NOOP(9995)),
/*32*/		CAPSABLE_CONTROL(UCSA('m'),UCSA('M'),UCSA(L'µ'),UCSA(L'Μ'),UCSA('m'-0x60),UCSA(0x00B5),UCSA(0x00BA),UCSA(0x2014),NOOP(9995)),
/*33*/		SHIFTABLE(UCSA(','),UCSA('<'),UCSA(L'ç'),UCSA(L'Ç'),UCSA(0x2026),UCSA(0x00D7),UCSA(0x0024),NOOP(9995)),
/*34*/		SHIFTABLE(UCSA('.'),UCSA('>'),UCSA(L'·'),UCSA(L'…'),UCSA(0x00B7),UCSA(0x00F7),UCSA(0x0023),NOOP(9995)),
/*35*/		SHIFTABLE(UCSA('/'),UCSA('?'),UCSA(L'¿'),UCSA(L'‽'),UCSA(0x0140),UCSA(0x013F),UCSA(0x2011),NOOP(9995)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
/*56*/		SHIFTABLE(UCSA(L'₨'),UCSA(L'₩'),UCSA(L'‱'),UCSA(L'※'),UCSA(0x0149),UCSA(0x00A6),UCSA(0x0266A),NOOP(9995)),
/*7D*/		SHIFTABLE(UCSA(L'¥'),UCSA(L'‾'),UCSA(L'‐'),UCSA(L'‑'),NOOP(9995),NOOP(9995),NOOP(9995),NOOP(9995)),
	},
	// 04: Modifier row
	{
/*2A*/		SIMPLE(MMNT(KBDMAP_MODIFIER_1ST_LEVEL2)),
/*36*/		SIMPLE(MMNT(KBDMAP_MODIFIER_2ND_LEVEL2)),
/*5D*/		SHIFTABLE(MMNT(KBDMAP_MODIFIER_1ST_LEVEL3),LOCK(KBDMAP_MODIFIER_1ST_GROUP2),MMNT(KBDMAP_MODIFIER_1ST_LEVEL3),LOCK(KBDMAP_MODIFIER_1ST_GROUP2),MMNT(KBDMAP_MODIFIER_1ST_LEVEL3),LOCK(KBDMAP_MODIFIER_1ST_GROUP2),MMNT(KBDMAP_MODIFIER_1ST_LEVEL3),LOCK(KBDMAP_MODIFIER_1ST_GROUP2)),
		SIMPLE(NOOP(0)),
/*1D*/		SIMPLE(MMNT(KBDMAP_MODIFIER_1ST_CONTROL)),
/*5A*/		SIMPLE(MMNT(KBDMAP_MODIFIER_2ND_CONTROL)),
/*69*/		SIMPLE(MMNT(KBDMAP_MODIFIER_1ST_SUPER)),
/*6A*/		SIMPLE(MMNT(KBDMAP_MODIFIER_2ND_SUPER)),
/*38*/		SIMPLE(MMNT(KBDMAP_MODIFIER_1ST_ALT)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
/*3A*/		SHIFTABLE(LOCK(KBDMAP_MODIFIER_CAPS),LOCK(KBDMAP_MODIFIER_LEVEL2),LOCK(KBDMAP_MODIFIER_CAPS),LOCK(KBDMAP_MODIFIER_LEVEL2),LOCK(KBDMAP_MODIFIER_CAPS),LOCK(KBDMAP_MODIFIER_LEVEL2),LOCK(KBDMAP_MODIFIER_CAPS),LOCK(KBDMAP_MODIFIER_LEVEL2)),
/*46*/		SIMPLE(LOCK(KBDMAP_MODIFIER_SCROLL)),
/*45*/		SIMPLE(LOCK(KBDMAP_MODIFIER_NUM)),
		SIMPLE(NOOP(0)),
 	},
	// 05: ISO 9995 "A" row
	{
/*73*/		SIMPLE(IMTH(EXTENDED_KEY_ROMAJI)),
/*70*/		SIMPLE(IMTH(EXTENDED_KEY_KATAHIRA)),
/*76*/		SIMPLE(IMTH(EXTENDED_KEY_HALF_FULL_WIDTH)),
/*77*/		SIMPLE(IMTH(EXTENDED_KEY_HIRAGANA)),
/*78*/		SIMPLE(IMTH(EXTENDED_KEY_KATAKANA)),
/*79*/		SIMPLE(IMTH(EXTENDED_KEY_HENKAN)),
/*7B*/		SIMPLE(IMTH(EXTENDED_KEY_MUHENKAN)),
		SIMPLE(NOOP(0)),
		...
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
/*39*/		SHIFTABLE(UCSA(' '),UCSA(' '),UCSA(' '),UCSA(' '),UCSA(0x202F),UCSA(0x200C),UCSA(0x00A0),NOOP(9995)),
	},
	...
	// 09: Function row 1
	{
		FUNKABLE1(1,13,25,37,EXTENDED_KEY_PAD_F1),
		FUNKABLE1(2,14,26,38,EXTENDED_KEY_PAD_F2),
		FUNKABLE1(3,15,27,39,EXTENDED_KEY_PAD_F3),
		FUNKABLE1(4,16,28,40,EXTENDED_KEY_PAD_F4),
		FUNKABLE1(5,17,29,41,EXTENDED_KEY_PAD_F5),
		FUNKABLE2(6,18,30,42),
		FUNKABLE2(7,19,31,43),
		FUNKABLE2(8,20,32,44),
		FUNKABLE2(9,21,33,45),
		FUNKABLE2(10,22,34,46),
		FUNKABLE2(11,23,35,47),
		FUNKABLE2(12,24,36,48),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
	...
	// 0D: Commands keypad "row" 1
	{
/*68*/		SIMPLE(NOOP(0)),
/*5C*/		SHIFTABLE(CONS(CONSUMER_KEY_NEXT_TASK),CONS(CONSUMER_KEY_PREVIOUS_TASK),NOOP(0),NOOP(0),CONS(CONSUMER_KEY_NEXT_TASK),CONS(CONSUMER_KEY_PREVIOUS_TASK),NOOP(0),NOOP(0)),
/*54*/		SIMPLE(EXTE(EXTENDED_KEY_ATTENTION)),
/*6B*/		SIMPLE(EXTE(EXTENDED_KEY_APPLICATION)),
/*6C*/		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
		SIMPLE(NOOP(0)),
...
overlay_group2_latch (
	...
	kbdmap_entry & e(keyboard[0x04][0x02]);
